...
// Expanded list of reviews with diverse names and ratings
const reviews = [
    ...
    <div className="min-h-screen bg-slate-50 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-10">
             ...
             <div className="inline-flex items-center gap-2 px-6 py-2 bg-white shadow-sm text-green-700 rounded-full text-sm font-bold border border-green-100 animate-pulse">
      ...
      <section className="pb-32 space-y-8">
        ...
        <div className="relative flex overflow-x-hidden group">
            ...
            <div className="animate-marquee flex gap-6 items-center px-4" style={{ animationDuration: '100s', animationDirection: 'reverse' }}>
