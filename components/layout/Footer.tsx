...
export const Footer = () => {
  return (
    <footer className="bg-white border-t border-gray-100 py-10">
      <div className="container mx-auto px-6 grid md:grid-cols-4 gap-8">
        <div className="md:col-span-1">
          <Link href="/" className="block mb-4">
            <span className="text-3xl font-great-vibes text-rothschild tracking-wide relative top-1">
                Paul Forbe
            </span>
          </Link>
        ...
        <div>
           <h4 className="font-bold text-rothschild mb-4 text-sm">Cabinet</h4>
           <ul className="space-y-2 text-xs text-gray-600 font-medium">
             <li><Link href="/" className="hover:text-rothschild transition-colors">Accueil</Link></li>
           </ul>
        </div>
        <div>
           <h4 className="font-bold text-rothschild mb-4 text-sm">Ressources</h4>
           <ul className="space-y-2 text-xs text-gray-600 font-medium">
             <li><Link href="/contact" className="hover:text-rothschild transition-colors">Contact</Link></li>
           </ul>
        </div>
        <div>
           <h4 className="font-bold text-rothschild mb-4 text-sm">Légal</h4>
           <ul className="space-y-2 text-xs text-gray-600 font-medium">
      ...
      <div className="container mx-auto px-6 mt-10 pt-6 border-t border-gray-100 text-center text-gray-400 text-xs">
